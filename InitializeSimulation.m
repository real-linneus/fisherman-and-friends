...
agents(5).population = 20000;
agents(5).interactionRadius = 1;
agents(5).radius = sqrt(agents(4).population);
...
agents(6).radius = sqrt(agents(3).population);
